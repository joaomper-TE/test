...
var _ MappedNullable = &EnterpriseAgent{}
...
type EnterpriseAgent struct {
	...
	AccountGroups []EnterpriseAgentAccountGroup `json:"accountGroups,omitempty"`
...
func (o *EnterpriseAgent) GetAccountGroups() []EnterpriseAgentAccountGroup {
	if o == nil || IsNil(o.AccountGroups) {
		var ret []EnterpriseAgentAccountGroup
		return ret
	}
...
// SetAccountGroups gets a reference to the given []EnterpriseAgentAccountGroup and assigns it to the AccountGroups field.
...
// SetIpv6Policy gets a reference to the given string and assigns it to the Ipv6Policy field.
...
// SetAgentState gets a reference to the given string and assigns it to the AgentState field.
...
func (o *EnterpriseAgent) GetKeepBrowserCache() bool {
	if o == nil || IsNil(o.KeepBrowserCache) {
		var ret bool
		return ret
	}
...
func (o *EnterpriseAgent) GetTargetForTests() string {
	if o == nil || IsNil(o.TargetForTests) {
		var ret string
		return ret
	}
...
func (o *EnterpriseAgent) GetLocalResolutionPrefixes() []string {
	if o == nil || IsNil(o.LocalResolutionPrefixes) {
		var ret []string
		return ret
	}
...
func (o *EnterpriseAgent) GetInterfaceIpMappings() []InterfaceIpMapping {
	if o == nil || IsNil(o.InterfaceIpMappings) {
